...
$sql = "
    ...
    WHERE d.controleur_id = ? AND d.statut = 'soumis_chef'
";
...
// Tri fixe : date réception descendante
...
<head>
    ...
    <title>Dossiers en cours - Agent CNSS</title>
...
<body class="with-sidebar">
    ...
    <main class="main-content">
        <div class="container-fluid py-4">
            <h2 class="h3 fw-bold text-primary mb-4">Dossiers en cours de traitement</h2>

            <!-- Filtres avec auto-submit sur selects + bouton pour dates/recherche -->
